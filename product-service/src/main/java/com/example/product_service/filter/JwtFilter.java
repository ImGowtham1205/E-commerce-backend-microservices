...
import com.example.product_service.jwt.JwtService;
import com.example.product_service.service.AuthMicroServiceCall;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,FilterChain filterChain)
        ...
        List<String> tokens = authService.getAllBlackListTokens(authHeader);
